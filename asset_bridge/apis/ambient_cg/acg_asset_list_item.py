...
class ACG_AssetListItem(AssetListItem):
    ...
    def __init__(self, name: str, data: dict):
        ...
        self.ab_categories = [t for t in self.ab_tags if t not in {"hdri", "3d"} and not re.match(r"\d+", t)]
    ...
    def download_preview(self, size: int = 128):
        url = f"https://acg-media.struffelproductions.com/file/ambientCG-Web/media/thumbnail/{size}-JPG-242424/{self.ab_name}.jpg"
