...
def draw_update_settings_ui(self: UpdaterPreferences, context: Context, layout: UILayout = None):
...
def register(bl_info):
    ...
    updater.user = "strike-digital"

    # Choose your own repository, must match git name for GitHUb and Bitbucket,
    # for GitLab use project ID (numbers only).
    updater.repo = "asset_bridge"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/strike-digital/asset_bridge"
    ...
    updater.include_branch_list = ["master", "main"]  # None is the equivalent = ['master']
